...
//	  @Override 
//	  public boolean modelExampleClassGenerated(TopLevelClass
//	  topLevelClass, IntrospectedTable introspectedTable) 
//	  { // add field,getter, setter for limit clause 
//	  
//	  addLimit(topLevelClass,introspectedTable, "limitStart"); 
//	  addLimit(topLevelClass,
//	  introspectedTable, "limitEnd"); 
...
//				new FullyQualifiedJavaType(Integer.class.getName());
//		Set<FullyQualifiedJavaType> importedTypes2 = new TreeSet<FullyQualifiedJavaType>();
//		importedTypes2.add(type_limit);
//		importedTypes2.add(type_offset);
//		importedTypes2.add(FullyQualifiedJavaType.getNewListInstance());
//		Method method2 = new Method();
//		method2.setVisibility(JavaVisibility.PUBLIC);
//		FullyQualifiedJavaType returnType2 = FullyQualifiedJavaType.getObjectInstance();
//		FullyQualifiedJavaType listType2;
//		if (introspectedTable.getRules().generateBaseRecordClass()) {
//			listType2 = new FullyQualifiedJavaType(introspectedTable
//					.getBaseRecordType());
//		} else if (introspectedTable.getRules().generatePrimaryKeyClass()) {
//			listType2 = new FullyQualifiedJavaType(introspectedTable
//					.getPrimaryKeyType());
...
//			throw new RuntimeException("RuntimeError.12");
//		}
//		method2.setReturnType(returnType2);
//		importedTypes.add(listType2);
//		returnType2.addTypeArgument(listType2);
//		method2.setName("listPage");
//		method2.addParameter(new Parameter(type_limit, "limit")); //$NON-NLS-1$ 
//		method2.addParameter(new Parameter(type_offset, "offset")); //$NON-NLS-1$
