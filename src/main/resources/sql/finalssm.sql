...
CREATE TABLE `sys_product` (
  ...
  `brand_id`    INT(11) DEFAULT NULL COMMENT '外键 关联品牌',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY(`id`)
...
CREATE TABLE `sys_product_image` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键自增长',
  `product_id` INT(11) DEFAULT NULL COMMENT '外键 对应商品',
...
CREATE TABLE `sys_product_property` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键自增长',
  `category_id` INT(11) DEFAULT NULL COMMENT '主键自增长',
...
CREATE TABLE `sys_product_property_value` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键自增长',
  `product_id` INT(11) DEFAULT NULL  COMMENT '外键 关联商品',
  `property_id` INT(11) DEFAULT NULL COMMENT '外键 关联商品属性',
