...
public class TripHotelBrand extends BaseEntity implements Serializable {
    //ID
    private Long id;
    ...
    //产品评论数量
    private Integer tripHotelCommentCount;
    ...
    public Integer getTripHotelCommentCount() {
        return tripHotelCommentCount;
    }

    public void setTripHotelCommentCount(Integer tripHotelCommentCount) {
        this.tripHotelCommentCount = tripHotelCommentCount;
    }
    ...
    public String toString() {
        ...
        sb.append(", tripHotelCommentCount=").append(tripHotelCommentCount);
    ...
    public enum Column {
        ...
        tripHotelCommentCount("trip_hotel_comment_count"),
        logo("logo"),
        bigPic("big_pic"),
        status("status"),
