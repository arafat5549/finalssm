...
public class TripScenicOrder extends BaseEntity implements Serializable {
    //ID
    private Long id;
    ...
    public Long getTripScenicBillId() {
        return tripScenicBillId;
    }

    public void setTripScenicBillId(Long tripScenicBillId) {
        this.tripScenicBillId = tripScenicBillId;
    }
    ...
    public String toString() {
        ...
        sb.append(", tripScenicBillId=").append(tripScenicBillId);
    ...
    public enum Column {
        ...
        score("score"),
        tripScenicBillId("trip_scenic_bill_id"),
        userId("user_id"),
