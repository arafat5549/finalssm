...
public class TripHotel extends BaseEntity implements Serializable {
    //ID
    private Long id;
    ...
    //自驾游酒店属性分类ID
    private Long tripHotelAttrCategoryId;

    // 自驾游酒店品牌ID
    private Long tripHotelBrandId;

    // 自驾游酒店分类ID
    private Long tripHotelCategoryId;
    ...
    public String getTripHotelSn() {
        return tripHotelSn;
    }

    public void setTripHotelSn(String tripHotelSn) {
        this.tripHotelSn = tripHotelSn;
    }
    ...
    public Long getTripHotelAttrCategoryId() {
        return tripHotelAttrCategoryId;
    }

    public void setTripHotelAttrCategoryId(Long tripHotelAttrCategoryId) {
        this.tripHotelAttrCategoryId = tripHotelAttrCategoryId;
    }

    public Long getTripHotelBrandId() {
        return tripHotelBrandId;
    }

    public void setTripHotelBrandId(Long tripHotelBrandId) {
        this.tripHotelBrandId = tripHotelBrandId;
    }

    public Long getTripHotelCategoryId() {
        return tripHotelCategoryId;
    }

    public void setTripHotelCategoryId(Long tripHotelCategoryId) {
        this.tripHotelCategoryId = tripHotelCategoryId;
    }
    ...
    public String toString() {
        ...
        sb.append(", tripHotelSn=").append(tripHotelSn);
        sb.append(", sort=").append(sort);
        sb.append(", sale=").append(sale);
        sb.append(", stock=").append(stock);
        sb.append(", lowStock=").append(lowStock);
        sb.append(", tripHotelAttrCategoryId=").append(tripHotelAttrCategoryId);
        sb.append(", tripHotelBrandId=").append(tripHotelBrandId);
        sb.append(", tripHotelCategoryId=").append(tripHotelCategoryId);
    ...
    public enum Column {
        ...
        tripHotelSn("trip_hotel_sn"),
        sort("sort"),
        sale("sale"),
        stock("stock"),
        lowStock("low_stock"),
        tripHotelAttrCategoryId("trip_hotel_attr_category_id"),
        tripHotelBrandId("trip_hotel_brand_id"),
        tripHotelCategoryId("trip_hotel_category_id"),
        imagePic("image_pic"),
