...
public class TripRouteOrder extends BaseEntity implements Serializable {
    //ID
    private Long id;
    ...
    public Long getTripRouteBillId() {
        return tripRouteBillId;
    }

    public void setTripRouteBillId(Long tripRouteBillId) {
        this.tripRouteBillId = tripRouteBillId;
    }
    ...
    public String toString() {
        ...
        sb.append(", tripRouteBillId=").append(tripRouteBillId);
    ...
    public enum Column {
        ...
        score("score"),
        tripRouteBillId("trip_route_bill_id"),
        userId("user_id"),
