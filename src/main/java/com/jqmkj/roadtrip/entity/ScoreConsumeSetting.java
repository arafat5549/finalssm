...
public class ScoreConsumeSetting extends BaseEntity implements Serializable {
    //
    private Long id;
    ...
    public enum Column {
        id("id"),
        deductionPerAmount("deduction_per_amount"),
        maxPercentPerOrder("max_percent_per_order"),
        useUnit("use_unit"),
