...
public class TripScenic extends BaseEntity implements Serializable {
    //ID
    private Long id;
    ...
    // 自驾游景区品牌ID
    private Long tripScenicBrandId;

    // 自驾游景区分类ID
    private Long tripScenicCategoryId;
    ...
    public String getTripScenicSn() {
        return tripScenicSn;
    }

    public void setTripScenicSn(String tripScenicSn) {
        this.tripScenicSn = tripScenicSn;
    }
    ...
    public Long getTripScenicBrandId() {
        return tripScenicBrandId;
    }

    public void setTripScenicBrandId(Long tripScenicBrandId) {
        this.tripScenicBrandId = tripScenicBrandId;
    }

    public Long getTripScenicCategoryId() {
        return tripScenicCategoryId;
    }

    public void setTripScenicCategoryId(Long tripScenicCategoryId) {
        this.tripScenicCategoryId = tripScenicCategoryId;
    }
    ...
    public String toString() {
        ...
        sb.append(", tripScenicSn=").append(tripScenicSn);
        sb.append(", sort=").append(sort);
        sb.append(", sale=").append(sale);
        sb.append(", stock=").append(stock);
        sb.append(", lowStock=").append(lowStock);
        sb.append(", tripScenicAttrCategoryId=").append(tripScenicAttrCategoryId);
        sb.append(", tripScenicBrandId=").append(tripScenicBrandId);
        sb.append(", tripScenicCategoryId=").append(tripScenicCategoryId);
    ...
    public enum Column {
        ...
        tripScenicSn("trip_scenic_sn"),
        sort("sort"),
        sale("sale"),
        stock("stock"),
        lowStock("low_stock"),
        tripScenicAttrCategoryId("trip_scenic_attr_category_id"),
        tripScenicBrandId("trip_scenic_brand_id"),
        tripScenicCategoryId("trip_scenic_category_id"),
        imagePic("image_pic"),
